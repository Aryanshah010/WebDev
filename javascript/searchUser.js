...
function showUsers(arr) {
  arr.forEach((element) => {
    ...
    blurredlayer.style.backgroundImage = `url(${element.pic})`;
...
searchBar.addEventListener("input", () => {
  let searchedUsers = users.filter((val) => {
    return val.name.startsWith(searchBar.value);
  });
